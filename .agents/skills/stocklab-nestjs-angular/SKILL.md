...
- **Branch naming**: `feature/<jira-id>-<mô-tả>`, `bugfix/<jira-id>-<mô-tả>`, `hotfix/<mô-tả>`
- **Commit message**: `[<MODULE>] <hành-động>: <mô-tả ngắn>`
  - Ví dụ: `[AUTH] feat: implement JWT login endpoint`
  - Ví dụ: `[ENGINE] fix: correct partial fill calculation`
- **Flow**: `feature branch` → PR → review → merge vào `main`
